...
# При работе с сетью и веб-сервисами иногда используется так называемая функция обратного вызова — это функция,
# которая вызывается при срабатывании определенного события
