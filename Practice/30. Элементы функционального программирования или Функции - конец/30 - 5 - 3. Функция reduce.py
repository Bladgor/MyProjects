...
# Она применяет указанную функцию к элементам последовательности, сводя её к единственному значению.
# Однако используют reduce довольно редко.
...
print(reduce(calculate_was, map(lambda x: 1 if 'was' in x else 0, sentences)))
